...
class MainWindowView(QObject):
    ...
    def _build_run_statistics_dialog(self):
        ...
        self.window.run_stats_consensus_button = QPushButton("Consensus")
        ...
        self.window.run_stats_consensus_button.setToolTip("Create a consensus run from visible runs in the current workflow")
        action_row.addWidget(self.window.run_stats_activate_button)
        action_row.addWidget(self.window.run_stats_accept_button)
        action_row.addWidget(self.window.run_stats_consensus_button)
