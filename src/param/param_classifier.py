...
class ParamPreprocessing():
    def __init__(self, image_size = 224, freq_range=[10,500], time_range=[0, 1000], fs=2000, crop_freq=[80,224], crop_time= 100):
    ...
    def to_dict(self):
        return {'image_size': self.image_size, 'freq_range': self.freq_range, 'time_range': self.time_range, 'fs': self.fs, 'crop_freq': self.crop_freq, 'crop_time': self.crop_time}
    @staticmethod
    def from_dict(param_dict):
